...
DEBUG = config('DEBUG', default=False, cast=bool)  # Changed from True to False
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='*').split(',')  # Support multiple hosts
...
# Media files (if you need to store user uploads)
MEDIA_URL = '/media/'
